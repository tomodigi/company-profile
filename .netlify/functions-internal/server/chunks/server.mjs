import { getCurrentInstance, inject, version, defineComponent, h, computed, unref, ref, Suspense, nextTick, Transition, provide, reactive, resolveComponent, shallowRef, isReadonly, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, onServerPrefetch, useSSRContext, withCtx, createVNode } from 'vue';
...
const appHead = { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }], "link": [{ "rel": "icon", "href": "/favicon.png" }, { "rel": "preconnect", "href": "https://fonts.googleapis.com" }, { "rel": "preconnect", "href": "https://fonts.gstatic.com", "crossorigin": "anonymous" }, { "rel": "stylesheet", "href": "https://fonts.googleapis.com/css2?family=Kanit:wght@600;700&family=Plus+Jakarta+Sans&display=swap" }], "style": [], "script": [], "noscript": [], "title": "Tomo Digital Creative", "htmlAttrs": { "lang": "en" } };
...
const _routes = [
  {
    ...
    component: () => import('./index-a3270a54.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./services-28960b37.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-107b4ffd.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component-1a411022.mjs').then((r) => r.default || r));
...
export { __nuxt_component_0$1 as _, useNuxtApp as a, createError as c, entry$1 as default, useRoute as u };
